...
pull requests, and discussions on this repository), and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported by opening a [GitHub
Issue](https://github.com/alexwbend/allelio/issues) or by contacting the
maintainer directly through GitHub ([@alexwbend](https://github.com/alexwbend)).
